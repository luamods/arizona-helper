...
function check_resourses()
	...
	if not doesFileExist(configDirectory .. '/Resourse/logo.png') then
		...
		downloadFileFromUrlToPath('https://downgit.github.io/#/home?url=https://github.com/luamods/arizona-helper/blob/main/Resourse/logo.png', configDirectory .. '/Resourse/logo.png')
